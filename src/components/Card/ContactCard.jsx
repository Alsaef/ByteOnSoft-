...
const ContactCard = ({title, btnTxt}) => {
    return (
        ...
        <h2 className='text-lg md:text-xl lg:text-2xl font-semibold text-[#4a3989] mb-3'>{title}</h2>
        ...
        <button type='submit' className='text-white text-lg md:text-xl font-semibold px-4 py-3 rounded-lg bg-[#4a3989] w-full'>{btnTxt}</button>
    </form>
    );
};
