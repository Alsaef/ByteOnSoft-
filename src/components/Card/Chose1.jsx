...
import choose1 from '../../assets/image2/choose-1.png';
import Image from 'next/image';
const Chose1 = () => {
    return (
        <div>
                <div className='flex flex-col md:flex-row items-center md:justify-center lg:justify-center gap-2'>
        


        <div className='justify-center'>
         
         <Image src={choose1} width={500} height={500} alt='work image'/>
        ...
        <div className='text-left md:px-3 px-4'>
          ...
          <h2 className='text-3xl font-semibold text-[#404040]'>Safeguard Your Brand with Cyber Security <br /> and IT Solutions</h2>
