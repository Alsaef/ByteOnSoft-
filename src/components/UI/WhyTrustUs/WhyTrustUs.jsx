...
const WhyTrustUs = () => {
    return (
        <div className='flex flex-col-reverse md:flex-row-reverse items-center justify-center md:justify-between lg:justify-between w-full md:w-4/5 p-5 md:p-10 lg:p-16 mx-auto'>
